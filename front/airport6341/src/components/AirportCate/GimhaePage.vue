  ...
  <div class="container">
      ...
      <div class="traffic">
        <div class="row">
          ...
          <div class="col-6">
            <h2 style="margin-bottom: 50px;">공항 주차장 혼잡도</h2>
              <el-descriptions direction="vertical" v-for="obj of state.parkinginfodata" :key="obj" border="1" style="width: 85%; margin-top: 30px; height: 85px; margin-right: 100px;">
      ...
      <div class="bording">
        <div class="flightlist">
          ...
          <select class="form-select"
              style="float: left; width: 220px; margin-top: 10px; font-size: 17px;  margin-right: 10px;" 
        ...
        <div class="waittime">
          ...
          <table class="table" style="width:100%; margin-top: 70px; margin-bottom: 30px;" >
            <thead>
              <tr style="font-size: 20px;">
...
export default {
    setup () {
      ...
      const handleSearch = async(hno) => {
        // router.push({path:'/board', query: { hno1 : 3, hno2 : hno }});
        router.push({path:'/board', query: { hno : [3,hno]}});
      };
      ...
      const handleData1 = async() => {
          const url = `/fligent/api/airportstore/selecttypeofbussiness.json?airportCode=PUS&typeOfBusiness=${state.typeofbusiness}&start=${state.page}`;
          const headers = {"Content-Type":"application/json"};
          const {data} = await axios.get(url, {headers});
          // console.log(data);
          if(data.status === 200){
